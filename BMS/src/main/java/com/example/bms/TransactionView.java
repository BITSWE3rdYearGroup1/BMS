...
public class TransactionView {
    ...
    public static StackPane loadTransactionTableView(){
        ...
        accountNumber.setPrefWidth(AdminView.UPdate.resize(accountNumber.getText()));
        ...
        id.setCellValueFactory(new PropertyValueFactory<Transaction,Integer>("id"));
        accountNumber.setCellValueFactory(new PropertyValueFactory<Transaction,String>("accountNumber"));
        destination.setCellValueFactory(new PropertyValueFactory<Transaction,String>("destination"));
        transactionType.setCellValueFactory(new PropertyValueFactory<Transaction,String>("transactionType"));
        transactionDate.setCellValueFactory(new PropertyValueFactory<Transaction,String>("transactionDate"));
        customerName.setCellValueFactory(new PropertyValueFactory<Transaction,String>("CustomerName"));
        tellerName.setCellValueFactory(new PropertyValueFactory<Transaction,String>("TellerName"));
